...
| **Solo CPU mining** | `dinero-solo-miner-2.2.6-rc1-*` | [`v2.2.6-rc1`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.6-rc1) | Wallet users should use the Mining tab. Standalone macOS arm64, Windows x64, Linux aarch64, and Linux x86_64 artifacts are live for power users and scripted solo miners. |
