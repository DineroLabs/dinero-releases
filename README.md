...
| **Mining / pool software** | `dinero-solo-miner-*`, `dinero-gpu-miner-*`, `dinero-sv2-miner-*`, `dinero-sv2-gpu-miner-*`, `dinero-sv2-pool-*`, `dinero-tp-*` | macOS arm64 standalone artifacts are live on [`v2.2.6-rc1`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.6-rc1). Windows x64 is live for `dinero-solo-miner`, `dinero-sv2-miner`, `dinero-sv2-pool`, and `dinero-tp`; Windows GPU lanes (`dinero-gpu-miner`, `dinero-sv2-gpu-miner`) and Linux standalone artifacts are follow-up lanes. |
