...
| **Solo CPU mining** | ⬇ [`dinero-solo-miner-2.2.6-rc1-macOS-arm64.tar.gz`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-solo-miner-2.2.6-rc1-macOS-arm64.tar.gz) / [`dinero-solo-miner-2.2.6-rc1-windows-win64.zip`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-solo-miner-2.2.6-rc1-windows-win64.zip) | [`v2.2.6-rc1`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.6-rc1) | Wallet users should use the Mining tab. macOS arm64 and Windows x64 standalone artifacts are live for power users and scripted solo miners. Linux standalone is a follow-up lane. |
...
| **SV2 pool workers** | ⬇ [`dinero-sv2-miner-2.2.6-rc1-macOS-arm64.tar.gz`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-sv2-miner-2.2.6-rc1-macOS-arm64.tar.gz) / [`dinero-sv2-miner-2.2.6-rc1-windows-win64.zip`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-sv2-miner-2.2.6-rc1-windows-win64.zip) / [`dinero-sv2-gpu-miner-2.2.6-rc1-macOS-arm64.tar.gz`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-sv2-gpu-miner-2.2.6-rc1-macOS-arm64.tar.gz) / [`dinero-sv2-gpu-miner-2.2.6-rc1-windows-win64.zip`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-sv2-gpu-miner-2.2.6-rc1-windows-win64.zip) | [`v2.2.6-rc1`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.6-rc1) | `dinero-sv2-miner` is the CPU pool worker; `dinero-sv2-gpu-miner` is the Metal (macOS) / OpenCL (Windows) pool worker. macOS arm64 + Windows x64 binaries are live for both. They connect to an SV2 pool and let the miner own the coinbase outputs. |
| **SV2 pool operators** | ⬇ [`dinero-sv2-pool-2.2.6-rc1-macOS-arm64.tar.gz`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-sv2-pool-2.2.6-rc1-macOS-arm64.tar.gz) / [`dinero-sv2-pool-2.2.6-rc1-windows-win64.zip`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-sv2-pool-2.2.6-rc1-windows-win64.zip) / [`dinero-tp-2.2.6-rc1-macOS-arm64.tar.gz`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-tp-2.2.6-rc1-macOS-arm64.tar.gz) / [`dinero-tp-2.2.6-rc1-windows-win64.zip`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.6-rc1/dinero-tp-2.2.6-rc1-windows-win64.zip) | [`v2.2.6-rc1`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.6-rc1) | `dinero-sv2-pool` is the reference pool server; `dinero-tp` is the Template Provider that binds to `dinerod`. This is operator software, not a wallet download. macOS arm64 + Windows x64 binaries are live for both. |
...
| **Mining / pool software** | `dinero-solo-miner-*`, `dinero-gpu-miner-*`, `dinero-sv2-miner-*`, `dinero-sv2-gpu-miner-*`, `dinero-sv2-pool-*`, `dinero-tp-*` | macOS arm64 + Windows x64 standalone artifacts are live for all six lanes on [`v2.2.6-rc1`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.6-rc1). Windows GPU binaries (`dinero-gpu-miner`, `dinero-sv2-gpu-miner`) load the system `OpenCL.dll` ICD and require vendor GPU drivers (AMD/Intel/NVIDIA); they were built and validated on a Parallels-ARM host that cannot expose a real GPU OpenCL platform, so first-run on real GPU hardware is the actual hash-rate validation. Linux standalone artifacts are a follow-up lane. |
