...
| **Windows desktop users (current recommendation)** | ⬇ **[`dinero-qt-2.2.5-rc7-windows-win64-preview.zip`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.5-rc7/dinero-qt-2.2.5-rc7-windows-win64-preview.zip)** | [`v2.2.5-rc7`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.5-rc7) | Portable zip — extract and double-click `dinero-qt.exe`. The MSI installer is temporarily withheld during Microsoft Defender false-positive review. |
| **Windows desktop installer** | `Dinero-Setup-2.2.5-rc7.msi` withheld | [`v2.2.5-rc7`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.5-rc7) | Temporarily hidden pending Microsoft Defender false-positive review. |
...
| **Windows desktop portable (64-bit, preview)** | `dinero-qt-2.2.5-rc7-windows-win64-preview.zip` | Current recommended Windows desktop download while the MSI installer is withheld for Microsoft Defender false-positive review. Extracts to `Dinero-Qt/`; double-click `dinero-qt.exe`. |
| **Windows desktop installer** | `Dinero-Setup-2.2.5-rc7.msi` | Temporarily hidden pending Microsoft Defender false-positive review. |
