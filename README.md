...
| **Windows desktop users (recommended)** | ⬇ **[`Dinero-Setup-2.2.5-rc7.msi`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.5-rc7/Dinero-Setup-2.2.5-rc7.msi)** | [`v2.2.5-rc7`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.5-rc7) | One-click MSI installer. C:\Program Files\Dinero, Start Menu shortcut, uninstall via Settings. Wallet datadir preserved on uninstall. |
| **Windows desktop power users / portable** | ⬇ [`dinero-qt-2.2.5-rc7-windows-win64-preview.zip`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.5-rc7/dinero-qt-2.2.5-rc7-windows-win64-preview.zip) | [`v2.2.5-rc7`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.5-rc7) | Portable zip — same binaries as the MSI, for testers / CI / VM smoke. |
| **Windows server operators** | ⬇ [`dinero-core-2.2.5-rc7-windows-win64-preview.zip`](https://github.com/DineroLabs/dinero-releases/releases/download/v2.2.5-rc7/dinero-core-2.2.5-rc7-windows-win64-preview.zip) | [`v2.2.5-rc7`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.5-rc7) | Daemon + CLI + service install/uninstall scripts. No Core MSI by design (operators want manual control). |
...
| **Windows desktop installer (recommended)** | `Dinero-Setup-2.2.5-rc7.msi` | One-click MSI installer — installs to `C:\Program Files\Dinero\`, Start Menu shortcut, optional desktop shortcut, optional "launch on finish". Uninstall through Settings → Apps; wallet datadir at `%APPDATA%\Dinero` is never touched on uninstall or upgrade. See the [`v2.2.5-rc7`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.5-rc7) page. |
| **Windows desktop portable (64-bit, preview)** | `dinero-qt-2.2.5-rc7-windows-win64-preview.zip` | Same binaries as the MSI but as a portable extract-and-run zip. For testers, CI, sandboxed users, VM smoke workflows. Extracts to `Dinero-Qt/`. |
| **Windows server operator (64-bit, preview)** | `dinero-core-2.2.5-rc7-windows-win64-preview.zip` | Daemon + CLI only, no GUI — `dinerod.exe`, `dinero-cli.exe`, runtime DLLs, plus `install-service.ps1` / `uninstall-service.ps1` for Windows service registration. Canonical Windows-aware datadir. Extracts to `Dinero-Core/`. ~16 MB. See the [`v2.2.5-rc7`](https://github.com/DineroLabs/dinero-releases/releases/tag/v2.2.5-rc7) page. |
